...
void momentum()
{
    ...
    const int srap =
        treeIn->GetConfiguration()->GetBranchConfig("SimParticles").GetFieldId("rapidity");
    ...
    TH1F hsphi("hsphi", "sim phi", 1000, 0, 3.2);
    ...
    TH1F hrphi("hrphi", "rec phi", 1000, 0, 3.2);
    ...
    TH2F hcphi("hcphi", "cor phi", 1000, 0, 3.1416, 1000, 0, 3.1416);
